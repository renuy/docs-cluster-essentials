# Deploying Cluster Essentials v1.7.2

This topic tells you how to install, upgrade, and uninstall Cluster Essentials v1.7.2.
...
1.  Select a download according to your Kubernetes provider and operating system:
    ...
    - For macOS, download `tanzu-cluster-essentials-darwin-amd64-1.7.2.tgz`.
    - For Linux, download `tanzu-cluster-essentials-linux-amd64-1.7.2.tgz`.
    - For Windows, download `tanzu-cluster-essentials-windows-amd64-1.7.2.tgz`.
...
1. For air-gapped installation, download the bundle:
    ...
    $ IMGPKG_REGISTRY_HOSTNAME=registry.tanzu.vmware.com \
      ...
      ./imgpkg copy \
        -b registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:c75374a9162b379a05d7852f8d98b6dcb5fe17e706b27bf736cdcdebf25f0804 \
...
- For online installation, run:
    ...
    ```console
    export INSTALL_BUNDLE=registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:c75374a9162b379a05d7852f8d98b6dcb5fe17e706b27bf736cdcdebf25f0804
...
- For air-gapped installation: 
    ...
    $ INSTALL_BUNDLE=MY-REGISTRY/cluster-essentials-bundle@sha256:c75374a9162b379a05d7852f8d98b6dcb5fe17e706b27bf736cdcdebf25f0804 \
...
- For online installation, run:
    ...
    set INSTALL_BUNDLE=registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:c75374a9162b379a05d7852f8d98b6dcb5fe17e706b27bf736cdcdebf25f0804
...
- For air-gapped installation: 
    ...
    set INSTALL_BUNDLE=MY-REGISTRY/cluster-essentials-bundle@sha256:c75374a9162b379a05d7852f8d98b6dcb5fe17e706b27bf736cdcdebf25f0804
...
For all other clusters, if you already have Cluster Essentials 1.0+ installed on your target cluster, you can upgrade to Cluster Essentials 1.7 using the following steps. Running this upgrade will update the `kapp-controller` version on your cluster to `v0.48.3` and `secretgen-controller` version to `v0.15.2`.
