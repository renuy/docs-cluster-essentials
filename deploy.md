# Deploying Cluster Essentials v1.6.6

This topic tells you how to install, upgrade, and uninstall Cluster Essentials v1.6.6.
...
1.  Select a download according to your Kubernetes provider and operating system:
    ...
    - For macOS, download `tanzu-cluster-essentials-darwin-amd64-1.6.6.tgz`.
    - For Linux, download `tanzu-cluster-essentials-linux-amd64-1.6.6.tgz`.
    - For Windows, download `tanzu-cluster-essentials-windows-amd64-1.6.6.tgz`.
...
1. For air-gapped installation, download the bundle:
    ...
    $ IMGPKG_REGISTRY_HOSTNAME=registry.tanzu.vmware.com \
      ...
      ./imgpkg copy \
        -b registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:sha256:5f4702820c297b50a4f2fcb815c1f8a39a2eee664887e1d225a94bd6a4ac9dba \
        --to-tar cluster-essentials-bundle-1.6.6.tar \
...
- For online installation, run:
    ...
    ```console
    export INSTALL_BUNDLE=registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:sha256:5f4702820c297b50a4f2fcb815c1f8a39a2eee664887e1d225a94bd6a4ac9dba
...
- For air-gapped installation: 
    ...
    $ IMGPKG_REGISTRY_HOSTNAME=MY-REGISTRY \
      ...
      ./imgpkg copy \
        --tar cluster-essentials-bundle-1.6.6.tar \
        --to-repo MY-REGISTRY/cluster-essentials-bundle \
        --include-non-distributable-layers \
        --registry-ca-cert-path CA_PATH

    $ INSTALL_BUNDLE=MY-REGISTRY/cluster-essentials-bundle@sha256:sha256:5f4702820c297b50a4f2fcb815c1f8a39a2eee664887e1d225a94bd6a4ac9dba \
...
- For online installation, run:
    ...
    set INSTALL_BUNDLE=registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:sha256:5f4702820c297b50a4f2fcb815c1f8a39a2eee664887e1d225a94bd6a4ac9dba
...
- For air-gapped installation: 
    ...
    set INSTALL_BUNDLE=MY-REGISTRY/cluster-essentials-bundle@sha256:sha256:5f4702820c297b50a4f2fcb815c1f8a39a2eee664887e1d225a94bd6a4ac9dba
...
For all other clusters, if you already have Cluster Essentials 1.0+ installed on your target cluster, you can upgrade to Cluster Essentials 1.6.6 using the following steps. Running this upgrade will update the `kapp-controller` version on your cluster to `v0.46.6` and `secretgen-controller` version to `v0.14.14`.
