# Deploying Cluster Essentials v1.6.8

This topic tells you how to install, upgrade, and uninstall Cluster Essentials v1.6.8.
...
1.  Select a download according to your Kubernetes provider and operating system:
    ...
    - For macOS, download `tanzu-cluster-essentials-darwin-amd64-1.6.8.tgz`.
    - For Linux, download `tanzu-cluster-essentials-linux-amd64-1.6.8.tgz`.
    - For Windows, download `tanzu-cluster-essentials-windows-amd64-1.6.8.tgz`.
...
1. For air-gapped installation, download the bundle:
    ...
    $ IMGPKG_REGISTRY_HOSTNAME=registry.tanzu.vmware.com \
      ...
      ./imgpkg copy \
        -b registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:sha256:d9181da9d3d7222bfeb3ffcf9f2a409658bd4d6c815dc0ccd71e631264fa89cb \
        --to-tar cluster-essentials-bundle-1.6.8.tar \
...
- For online installation, run:
    ...
    ```console
    export INSTALL_BUNDLE=registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:sha256:d9181da9d3d7222bfeb3ffcf9f2a409658bd4d6c815dc0ccd71e631264fa89cb
...
- For air-gapped installation: 
    ...
    $ IMGPKG_REGISTRY_HOSTNAME=MY-REGISTRY \
      ...
      ./imgpkg copy \
        --tar cluster-essentials-bundle-1.6.8.tar \
        --to-repo MY-REGISTRY/cluster-essentials-bundle \
        --include-non-distributable-layers \
        --registry-ca-cert-path CA_PATH

    $ INSTALL_BUNDLE=MY-REGISTRY/cluster-essentials-bundle@sha256:sha256:d9181da9d3d7222bfeb3ffcf9f2a409658bd4d6c815dc0ccd71e631264fa89cb \
...
- For online installation, run:
    ...
    set INSTALL_BUNDLE=registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:sha256:d9181da9d3d7222bfeb3ffcf9f2a409658bd4d6c815dc0ccd71e631264fa89cb
...
- For air-gapped installation: 
    ...
    set INSTALL_BUNDLE=MY-REGISTRY/cluster-essentials-bundle@sha256:sha256:d9181da9d3d7222bfeb3ffcf9f2a409658bd4d6c815dc0ccd71e631264fa89cb
...
For all other clusters, if you already have Cluster Essentials 1.0+ installed on your target cluster, you can upgrade to Cluster Essentials 1.6.8 using the following steps. Running this upgrade will update the `kapp-controller` version on your cluster to `v0.46.8` and `secretgen-controller` version to `v0.14.14`.
