# Deploying Cluster Essentials v1.4.7

This topic tells you how to install, upgrade, and uninstall Cluster Essentials v1.4.7.
...
1.  Select a download according to your Kubernetes provider and operating system:
    ...
    - For macOS, download `tanzu-cluster-essentials-darwin-amd64-1.4.7.tgz`.
    - For Linux, download `tanzu-cluster-essentials-linux-amd64-1.4.7.tgz`.
    - For Windows, download `tanzu-cluster-essentials-windows-amd64-1.4.7.tgz`.
...
1. Configure and run `install.sh`, which will install `kapp-controller` and `secretgen-controller` on your cluster:
    ...
    - For online installation, run:
        ...
        ```
        export INSTALL_BUNDLE=registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:3b596ef712f80da76e13c9b200d967d035840d61b06bf4b23111aac6bbcc49ca
    ...
    - For air-gapped installation, run:
        ...
        $ IMGPKG_REGISTRY_HOSTNAME=registry.tanzu.vmware.com \
          ...
          imgpkg copy \
            -b registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:3b596ef712f80da76e13c9b200d967d035840d61b06bf4b23111aac6bbcc49ca \
            --to-tar cluster-essentials-bundle-1.4.7.tar \
        ...
        $ IMGPKG_REGISTRY_HOSTNAME=MY-REGISTRY \
          ...
          imgpkg copy \
            --tar cluster-essentials-bundle-1.4.7.tar \
            --to-repo MY-REGISTRY/cluster-essentials-bundle \
            --include-non-distributable-layers \
            --registry-ca-cert-path CA_PATH

        $ INSTALL_BUNDLE=MY-REGISTRY/cluster-essentials-bundle@sha256:3b596ef712f80da76e13c9b200d967d035840d61b06bf4b23111aac6bbcc49ca \
...
1. Configure and run `install.bat`, which will install `kapp-controller` and `secretgen-controller` on your cluster:
    ...
    - For online installation, run:
        ...
        set INSTALL_BUNDLE=registry.tanzu.vmware.com/tanzu-cluster-essentials/cluster-essentials-bundle@sha256:3b596ef712f80da76e13c9b200d967d035840d61b06bf4b23111aac6bbcc49ca
    ...
    - For air-gapped installation, run:
        ...
        set INSTALL_BUNDLE=MY-REGISTRY/cluster-essentials-bundle@sha256:3b596ef712f80da76e13c9b200d967d035840d61b06bf4b23111aac6bbcc49ca
...
For all other clusters, if you already have Cluster Essentials 1.0+ installed on your target cluster, you can upgrade to Cluster Essentials 1.4.7 using the following steps. Running this upgrade will update the `kapp-controller` version on your cluster to `v0.44.11` and `secretgen-controller` version to `v0.13.7`.
